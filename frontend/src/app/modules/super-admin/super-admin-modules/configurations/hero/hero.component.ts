...
export class HeroComponent implements OnInit {
  ...
  selectFile(files: any) {
    ...
    if (extension != 'json') {
      ...
      this.configForm.controls['jsonFile'].reset()
        return;
    }
  ...
  selectFile2(files: any) {
    ...
    if (extension != 'png') {
      ...
      this.configForm.controls['pngFile'].reset()
        return;
    }
  ...
  onSubmit() {
    ...
    if (this.selectLogo2 && this.selectLogo2.name) {
      fd.append('pngFile', this.selectLogo2, this.selectLogo2.name);
    }
