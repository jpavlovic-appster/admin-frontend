...
class SuperAdminChangePasswordMail implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $data['link'] =  env("APP_URL_FRONT_SUB")."/super-admin/login";

        Mail::send('emails.super.change_password', $data, function($message) {
