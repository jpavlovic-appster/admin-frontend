...
<table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="926c033e-3c2c-426c-9211-22eaa0b63e74">
    <tbody>
      <tr>
        ...
        <div style="font-family: inherit; text-align: left"><br></div>
        <div style="font-family: inherit; text-align: left"> To view your banner please <a style="color: #007bff;" href="{{ $banner }}" target="_blank"> click here </a> </div>

        <div style="font-family: inherit; text-align: left"><br></div>
        <div style="font-family: inherit; text-align: left"> Please <a style="color: #007bff;" href="{{ $link }}" target="_blank"> click here </a> to login. </div>
