...
<table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="926c033e-3c2c-426c-9211-22eaa0b63e74">
    <tbody>
      <tr>
        ...
        <div style="font-family: inherit; text-align: left"> Your password has been changed now your new password is {{ $password }} </div>

        <!-- <div style="font-family: inherit; text-align: left"><br></div> -->
        <!-- <div style="font-family: inherit; text-align: left"> Please  <a href="http://ec2-52-28-79-37.eu-central-1.compute.amazonaws.com/subscriber/login" target="_blank">click here </a> to login. </div> -->
